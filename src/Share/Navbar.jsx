...
const Navbar = () => {
    ...
    const Navbar = <>
        ...
        <NavLink to='/explorespace' className={({ isActive }) => isActive ? "border-[#ff5d34] border text-[#ff5d34]" : "text-[#131313]"}>Explore Space</NavLink>
        <NavLink to='/comparison' className={({ isActive }) => isActive ? "border-[#ff5d34] border text-[#ff5d34]" : "text-[#131313]"}>Comparison</NavLink>
        <NavLink to='/game' className={({ isActive }) => isActive ? "border-[#ff5d34] border text-[#ff5d34]" : "text-[#131313]"}>Game</NavLink>
        <NavLink to='/eventalert' className={({ isActive }) => isActive ? "border-[#ff5d34] border text-[#ff5d34]" : "text-[#131313]"}>Event Alert</NavLink>
            ...
            <div className="lg:w-11/12 mx-auto">
                <div className="navbar bg-base-100">
                    <div className="navbar-start relative">
                        ...
                        <h1 className="text-6xl font-semibold">Astro</h1>
                    </div>
